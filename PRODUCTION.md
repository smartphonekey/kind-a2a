...
| Operations | Pending; two-component local deployment restoration verified | 26 subprocess cases cover restoration, partial deployment, lost patch acknowledgement, rollout failure, external edits, identity changes and busy-lab refusal. Live runner/orchestrator restoration, capability withdrawal and zero leftover Pods were independently checked. Production admission/backpressure, graceful draining, readiness, backup/restore, schema migration, retention and disaster recovery still need acceptance. |
