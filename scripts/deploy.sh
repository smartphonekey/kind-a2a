...
docker build -f "$lab_root/Dockerfile.runner" -t aira-a2a-runner:0.3.0 "$lab_root"
docker build -f "$lab_root/Dockerfile.controller" -t aira-a2a-controller:0.3.0 "$lab_root"
kind load docker-image --name aira-a2a-lab --nodes aira-a2a-lab-control-plane aira-a2a-runner:0.3.0 aira-a2a-controller:0.3.0
