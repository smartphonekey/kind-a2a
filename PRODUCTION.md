...
| Existing behavior | Baseline preserved | Build and all 323 tests including subtests pass on 2026-09-14, including the 10 baseline tests and 79 read-only upgrade audit tests, on pinned Node 24.21.0 / SQLite 3.53.4. |
...
Seven additional dependent prepared-workload branches cover the
