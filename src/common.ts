...
export const RUNNER_IMAGE = process.env.AIRA_RUNNER_IMAGE ?? "aira-a2a-runner:0.3.0";
export const MAX_ACTIVE_SANDBOXES = Number(process.env.AIRA_MAX_ACTIVE_SANDBOXES ?? "2");
