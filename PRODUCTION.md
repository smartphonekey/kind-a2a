...
the additive migration remains. Native regressions, infrastructure fencing and
production rollout gates are still pending. See
...
| --- | --- | --- |
| Existing behavior | Baseline preserved | Build and all 145 top-level tests pass on 2026-09-13 (156 including subtests), including the 10 baseline tests. |
